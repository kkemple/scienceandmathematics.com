...
function generatePdf(
  ...
  // Use zenodoDescription for PDF abstract if available, convert Unicode to LaTeX
  const rawAbstract = frontmatter.zenodoDescription || frontmatter.description;
  const abstract = unicodeToLatex(rawAbstract);
