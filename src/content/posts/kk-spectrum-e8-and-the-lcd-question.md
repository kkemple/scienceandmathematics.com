...
zenodoDescription: |
  ...
  The eigenvalue counting function N(λ) exhibits a Weyl exponent crossover at the Coxeter threshold: d_eff ≈ 2.61 in the semigroup-controlled regime (excitation-only count, l ≤ 30), crossing to d_eff → 3 asymptotically, verified to 0.3% at l = 500. The orbifold is topologically three-dimensional but spectrally behaves as dimension ~2.6 at low energies.
