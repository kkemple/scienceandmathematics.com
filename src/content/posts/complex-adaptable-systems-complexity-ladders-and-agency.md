...
description: "Complexity builds through a recursive ladder — constraints, structure, invariance, emergence — repeating at every scale. Agency appears when overhead reaches η ~ 0.1, balancing complexity with remaining energy."
pubDate: '2025-10-18'
updatedDate: '2026-01-28'
zenodoDepositionId: 18511936
zenodoUrl: "https://zenodo.org/records/18511936"
doi: "10.5281/zenodo.18511936"
keywords:
  - "complexity"
  - "emergence"
  - "agency"
...
zenodoDescription: |
  ...
  The dissipation β-function from constraint geometry governs how maintenance overhead η flows across scales. The observed hierarchy — particles at η ~ 10⁻⁶, atoms at ~10⁻³, molecules at ~10⁻², biological systems at ~10⁻¹ — represents successive plateaus in this flow, each corresponding to a completed ladder iteration.

  Agency — goal-directed navigation — requires both sufficient organizational complexity and sufficient remaining energy to act. Biological systems at η ~ 0.1 occupy a narrow thermodynamic window where these conditions coexist. Below η ~ 0.05, organizational depth is insufficient for representing alternative trajectories. As η approaches saturation, maintenance costs consume available capacity. Most of the universe operates outside this window, completing ladder iterations and building complexity without achieving agency.
---
...
Each iteration of the ladder adds an organizational layer operating at a characteristic maintenance overhead $\eta$, the fraction of a system's energy budget devoted to curvature maintenance. The monograph's [dissipation $\beta$-function](/triadic-tension-decade-symmetry-and-dissipation-flow-in-constraint-geometry) governs how $\eta$ flows across scales, driven by the coupling constant $\rho^* = 4\pi\varphi^2/10 \approx 3.29$ derived from triadic tension. The observed dissipation hierarchy — particles at $\eta \sim 10^{-6}$, atoms at $\sim 10^{-3}$, molecules at $\sim 10^{-2}$, biological systems at $\sim 10^{-1}$ — represents successive plateaus in this flow, each corresponding to a completed ladder iteration at a new organizational scale.
...
At this scale, something qualitatively new appears. Biological systems operating at maintenance overhead $\eta \sim 0.1$ reach the thermodynamic window where agency becomes possible.
...
The ladder ascends unidirectionally because curl accumulation is one-way. Additional constraints can introduce new circulation, but removing circulation requires eliminating the constraints that produced it — which destroys the organizational structure itself. Descent is structurally unavailable. This connects to the monograph's dissipation flow: the $\beta$-function drives $\eta$ upward under coarse-graining, consistent with irreversible accumulation of maintenance cost across scales.

## The Thermodynamic Window for Agency

Agency — goal-directed navigation using environmental information to modify trajectory — requires both sufficient organizational complexity and sufficient remaining energy to act. The monograph's dissipation hierarchy places biological systems at $\eta \sim 10^{-1}$, the highest observed maintenance regime before black hole saturation at $\eta = 1$.
...
**The agency window.** The placement of biological agency at $\eta \sim 0.1$ is empirical, not derived from the constraint geometry. A system exhibiting genuine goal-directed behavior well below $\eta \sim 0.05$ would challenge the thermodynamic window claim. Conversely, an artificial system achieving biological-scale organizational depth at much lower $\eta$ through architectural innovation would demonstrate that the window's boundaries depend on architecture rather than constraint geometry alone.
