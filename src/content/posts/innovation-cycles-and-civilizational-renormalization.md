...
keywords:
  ...
  - "thermodynamics"
zenodoDescription: |
  This paper distinguishes between mechanics (natural causal substrates like thermodynamics, electromagnetism, nuclear binding) and interventions (tools and systems humans build to harness those mechanics). The central claim: mechanics don't saturate, but intervention spaces do.

  Civilizational capacity is the density and height of the intervention stack across known mechanics. Each layer is prerequisite to the next—you can't skip rungs. Advanced technologies harness multiple mechanics simultaneously, creating fragile dependencies on layers beneath.

  As civilizations fill the intervention space on available mechanics, marginal returns diminish while coordination overhead rises. At saturation, complexity outpaces the surplus the intervention portfolio can sustain. Agents respond rationally by shortening time horizons—fragmentation, rent-seeking, and defensive behavior are diagnostic signals, not moral failures.

  At saturation, civilizations face bifurcation: breakthrough (a new intervention becomes viable, creating slack for complexity to reorganize) or simplification (complexity sheds through institutional failure, fragmentation, or violence). Collapse is path-damaging—it destroys not just the top of the stack but interconnections and discovery capacity. Recovery isn't "climb back up" but rebuild with gaps you can't see.

  Historical examples illustrate the pattern: Bronze Age collapse occurred when iron was known but the intervention stack for scaling it wasn't viable within existing complexity; Rome had surface exposure to heat/pressure mechanics but lacked stack depth to formalize thermodynamics; the Industrial Revolution succeeded because accumulated tinkering built stack depth where thermodynamic discovery and steam intervention happened close together.

  The working hypothesis: behavioral pathologies near saturation are constraint-driven responses, not causes. The question at any saturation point is whether a new intervention arrives before complexity outpaces surplus and the stack starts losing rungs.
---

Mechanics are natural causal substrates—thermodynamics, electromagnetism, nuclear binding energy, chemical bonds, quantum effects. They exist independent of human activity.
...
Rome saturated on agricultural and slave labor interventions[^2]. The empire had surface exposure to heat and pressure mechanics—Hero of Alexandria's Aeolipile demonstrated steam power in the first century CE. But Rome lacked the accumulated stack depth to formalize thermodynamics or scale a steam intervention. The gap between knowing about a mechanic and building viable interventions on it can span centuries.
